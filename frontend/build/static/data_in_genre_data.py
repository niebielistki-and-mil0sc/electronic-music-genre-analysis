...
def generate_image_paths(genre_list, base_path):
    return {genre: f"/genre_images/{genre.replace(' ', '_').lower()}.webp" for genre in genre_list}
...
if __name__ == "__main__":
    ...
    md_descriptions = parse_markdown_descriptions("genre_descriptions/v3_guide.md")
    image_paths = generate_image_paths(normalized_genre_list, "public/static/genre_images")
    genre_artists = extract_artists("genre_descriptions/v3_tracks.csv")
